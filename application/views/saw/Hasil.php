                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    <th class="text-start" style="width: 70px;">Rank</th>
                                    <th class="text-start">Kode</th>
                                    <th class="text-start">Nama Alternatif</th>
                                    <th class="text-start">Jabatan</th>
                                    <th class="text-start" style="width: 180px;">Nilai Akhir</th>
                                ...
                                <?php if (!empty($hasil)): ?>
                                    <?php foreach ($hasil as $row): ?>
                                        <tr>
                                            ...
                                            <td class="text-start"><code class="fw-bold small text-primary"><?= htmlspecialchars($row['kode']) ?></code></td>
                                            <td class="text-start fw-semibold"><?= htmlspecialchars($row['nama_alternatif']) ?></td>
                                            <td class="text-start text-muted small"><?= htmlspecialchars($row['jabatan'] ?? '-') ?></td>

                                            <td class="text-start">
                                                <div class="d-flex align-items-center gap-2">
                                                    <span class="fw-bold text-primary"><?= number_format($row['nilai_akhir'], 3) ?></span>
                                    ...
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <!-- Tampilan Data Kosong yang Lebih Proposional -->
                                    <tr>
