            ...
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body py-3 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <p class="text-muted text-uppercase small fw-semibold mb-0">Total User</p>
                            <h3 class="mb-0 fw-bold"><?= number_format($total_user ?? 0) ?></h3>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <!-- Total Alternatif (ikon disamakan dengan sidebar) -->
        <div class="col-12 col-sm-6 col-lg-4">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body py-3 px-4">
                    <div class="d-flex align-items-center">
        ...
        <div class="col-12 col-lg-8">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-transparent d-flex justify-content-between align-items-center py-3">
                    ...
                    <a href="<?= base_url('admin/laporan') ?>" class="btn btn-sm btn-outline-primary rounded-pill">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex align-items-center px-0 py-2">
                            ...
                            <div>
                                ...
                                <small class="text-muted" id="liveClockAdmin"></small>
                            </div>
                        </div>
                        <div class="list-group-item d-flex align-items-center px-0 py-2">
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-transparent d-flex justify-content-between align-items-center py-3">
                    ...
                    <a href="<?= base_url('admin/laporan') ?>" class="btn btn-sm btn-primary rounded-pill">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (labels.length === 0) {
            // Tampilkan chart kosong tanpa data contoh
